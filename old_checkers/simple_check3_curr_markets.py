    ...
    while idx < total_markets:
        ...
        try:
            for _ in range(BATCH_LIMIT):
                ...
                # Need full meta once to get outcomePrices
                full_meta = fetch_market_meta(cid)
                outcome_raw = full_meta.get("outcomePrices", ["0", "0"])
        ...
        # ✅ NO early stop just because bets_this_batch == 0
        # Loop will continue until idx >= total_markets or bank < MIN_BANK
